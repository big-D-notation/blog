...
class UserDB:
    def __init__(self):
        ...
        self.create_table()
    # Створює всі необхідні таблиці (posts, users, comments)
    ...
    # Отримує користувача за його ім'ям
    def get_user(self, username):
        query = "SELECT * FROM users WHERE username = ?"
        self.cursor.execute(query, (username,))
        return self.cursor.fetchone()
   
    # Додає користувача до БД
